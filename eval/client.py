...
polyglot.export_value("foo", value=42)
polyglot.eval(language="js", path="juel.js")
polyglotExampleThing = polyglot.import_value("bar")
...
##               pass # huh??
    ...
    async def forum_thread_create(
        ...
        components=None, embed=None, file=None, nonce=None, reply_fail_fallback=False, slowmode=None, sticker=None,
